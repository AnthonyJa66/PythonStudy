list1=[8,1,2,3,4,5,6,[1,5,6,8]]
#sorted(数据容器, reverse=布尔值)，对容器排序（从小到大，不会改变原容器），返回值：经过排序的新容器。
# print(sorted(list1))
